  ...
  return (
    <MobilePremiumFrame variant="surface" className="mobile-devotion-list-item overflow-hidden">
      <Link
        ...
        className="theme-light-surface group flex min-h-[4.75rem] items-stretch bg-gradient-to-br from-white via-sand-50/80 to-clay-50/40 transition active:scale-[0.99] hover:shadow-md dark:from-[var(--color-bg-soft)] dark:via-[var(--color-surface)] dark:to-[var(--color-bg-muted)] sm:min-h-[5rem]"
      >
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3 px-3.5 py-3 sm:px-4">
          <div className="min-w-0 flex-1">
            ...
            <h3 className="mt-0.5 font-display text-base font-semibold leading-snug tracking-tight text-night-900 dark:text-sand-100 sm:text-lg">
              {devotion.title}
            </h3>
            {devotion.reference ? (
