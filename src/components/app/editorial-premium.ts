...
export const editorialPremium = {
  pageHeader:
    "editorial-page-header mb-4 overflow-hidden rounded-[1.35rem] border border-night-900/8 bg-sand-50 p-5 shadow-[0_1px_2px_rgba(45,36,24,0.04),0_12px_32px_rgba(45,36,24,0.06)]",
  pageEyebrow:
  ...
  leadCard:
    "editorial-lead-card rounded-[1.25rem] border border-night-900/8 bg-white/70 p-4 text-sm leading-relaxed text-night-700 shadow-[0_1px_2px_rgba(45,36,24,0.04)] sm:p-5",
    card:
      "editorial-card rounded-[1.25rem] border border-night-900/8 bg-white p-4 shadow-[0_1px_2px_rgba(45,36,24,0.04),0_8px_24px_rgba(45,36,24,0.05)] sm:p-5",
  primaryButton:
  ...
  quote:
    "editorial-quote rounded-[1.35rem] border border-night-900/8 bg-white/75 p-5 shadow-[0_1px_2px_rgba(45,36,24,0.04),0_8px_24px_rgba(45,36,24,0.05)] sm:p-6",
  section:
    "editorial-section rounded-[1.35rem] border border-night-900/8 bg-white p-5 shadow-[0_1px_2px_rgba(45,36,24,0.04),0_8px_24px_rgba(45,36,24,0.05)] sm:p-6",
  surface:
    "editorial-surface rounded-[1.25rem] border border-night-900/8 bg-white shadow-[0_1px_2px_rgba(45,36,24,0.04),0_8px_24px_rgba(45,36,24,0.05)]",
  navActive:
