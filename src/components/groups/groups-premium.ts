...
export const groupsPremium = {
  page: "groups-premium-page min-w-0 bg-sand-50 font-sans",
  ...
  listRow:
    "groups-premium-list-row flex items-center gap-3 rounded-[1.25rem] border border-night-900/8 bg-white px-3.5 py-3.5 shadow-[0_1px_2px_rgba(45,36,24,0.04),0_8px_24px_rgba(45,36,24,0.05)] transition active:scale-[0.995] hover:shadow-[0_12px_32px_rgba(45,36,24,0.08)]",
  iconTile:
  ...
  rowInset:
    "flex items-center justify-between gap-3 rounded-2xl bg-sand-50/80 px-3.5 py-3",
  leaderChip:
    "inline-flex items-center gap-1.5 rounded-full bg-sand-50 px-2.5 py-1 text-xs font-semibold tracking-tight text-night-800 ring-1 ring-night-900/8",
  statusChip: editorialPremium.badgeOutline,
  quickAction:
    "inline-flex min-w-0 flex-1 items-center justify-center gap-2 rounded-2xl bg-sand-50 px-3 py-3 text-sm font-semibold tracking-tight text-night-900 ring-1 ring-night-900/8 transition hover:bg-white active:scale-[0.98]",
  pillTrack:
